...
I often use this for testing HTML coming back from servers. I also am using it in [Muxt](https://github.com/typelate/muxt). If you like hypertext, definitely go take a look.
